...
System.bundles = {"bundles/bit-docs-site/static.css!":["bit-docs-html-canjs@0.4.3#static/canjs.less!$less","bit-docs-prettify@0.1.0#prettify.less!$less","bit-docs-site@0.0.1#styles/styles.less!$less"]};
/*npm-utils*/
...
define('package.json!npm', [
    ...
    (function (loader, packages, options) {
        ...
        },
        {
            ...
            'globalBrowser': {},
            'browser': {},
            'resolutions': { 'bit-docs-html-canjs': '0.4.3' }
        },
        {
...
/*bit-docs-html-canjs@0.4.3#static/canjs*/
define('bit-docs-html-canjs@0.4.3#static/canjs', function (require, exports, module) {
    require('./canjs.less!');
    $ = require('jquery');
    var $articleContainer, $onThisPage, $tableOfContents, $onThisPageTitle, $everything, $headers, headerHidden, scrolled;
    setState();
    ...
    function setOnThisPageScroll() {
        if ($articleContainer[0].scrollHeight - $articleContainer.scrollTop() === $articleContainer.outerHeight()) {
            ...
            var contOffsetTop = $articleContainer.offset().top, headerContent;
    ...
    function getHeaders() {
        var outline = window.docObject && parseInt(window.docObject.outline), outlineLevel = !isNaN(outline) ? outline : 1, headerArr = [];
    ...
    function buildTOC() {
        ...
        var level = 0, baseLevel = $headers[0].nodeName.substr(1), toc = '<ol>';
